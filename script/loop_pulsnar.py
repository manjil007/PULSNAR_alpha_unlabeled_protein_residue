...
DATASETS = {
    "balanced_dataset": {
        ...
        "yaml"   : "pulsnar_residues_alpha_balanced.yaml",
    },
...
def read_input_files(feature_file: Path,
    ...
    kept_mask = ~nan_mask
    X_df = X_df.loc[kept_mask]
    y_df    = y_df.loc[kept_mask]
    y_true_df = y_true_df.loc[kept_mask]
